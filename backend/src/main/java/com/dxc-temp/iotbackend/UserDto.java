...
/**
 * DTO for user registration and authentication input.
 */
public class UserDto {
    ...
    /**
     * No-args constructor required for frameworks (e.g., Jackson, Hibernate).
     */
    public UserDto() {
        // Default constructor required for deserialization and reflection
    }
